  ...
  try {
    ...
    if (isProduction || isVercel) {
      try {
        ...
        console.error('@sparticuz/chromium is required for Vercel deployment but not found:', error.message);
        throw new Error('Missing @sparticuz/chromium package required for Vercel deployment. Please install it with: npm install @sparticuz/chromium');
      }
    } else {
      ...
      try {
        ...
        console.log('@sparticuz/chromium not available for local development, will use system Chrome');
        chromium = null;
      }
    }
