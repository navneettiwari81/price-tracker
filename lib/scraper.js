...
/**
 * Scrapes a given URL for product title and price using playwright-core with @sparticuz/chromium.
 * This version is optimized for serverless deployment (Vercel).
...
async function scrapeProduct(url) {
  ...
  try {
    ...
    // Launch browser with external Chromium optimized for serverless
